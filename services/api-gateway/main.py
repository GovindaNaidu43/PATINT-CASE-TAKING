...
for router in (patients_router, consultations_router, dialogue_router, ocr_router, signals_router, summaries_router, abdm_router, followup_router, operations_router): app.include_router(router)
