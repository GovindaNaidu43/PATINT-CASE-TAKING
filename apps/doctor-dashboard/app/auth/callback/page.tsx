...
export default function AuthCallback() {
  return <Suspense fallback={<main className="min-h-screen grid place-items-center bg-royal-bg text-royal-ivory">Completing secure sign-in…</main>}><AuthCallbackContent /></Suspense>
}
